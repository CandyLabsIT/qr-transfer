...
void main() {
  ...
  group('Tests of HexCoder.encode()', () {
    test('Should [return UPPERCASE hexadecimal] from given bytes', () {
      Uint8List actualDataToEncode = asciiCodeBytes;

      // Act
      String actualHexResult = HexCoder.encode(actualDataToEncode, lowercaseBool: false);
    ...
    test('Should [return LOWERCASE hexadecimal] from given bytes', () {
      ...
      // Act
      String actualHexResult = HexCoder.encode(actualDataToEncode, lowercaseBool: true);
  ...
  group('Tests of HexCoder.decode()', () {
    test('Should [return Uint8List] decoded from given [UPPERCASE hexadecimal] [with 0x prefix]', () {
      ...
      // Act
      Uint8List actualDecodedHexResult = HexCoder.decode('0x$actualHexToDecode');
    ...
    test('Should [return Uint8List] decoded from given [UPPERCASE hexadecimal] [without 0x prefix]', () {
      ...
      // Act
      Uint8List actualDecodedHexResult = HexCoder.decode(actualHexToDecode);
